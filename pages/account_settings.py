...
def account_settings():
    ...
    with cols[1]:
        st.markdown("<h1 style='color: #f5c472; text-align:center;'>Account Settings</h1>", unsafe_allow_html=True)

        with st.container(border=True):
            current_tab = sac.tabs([
                sac.TabsItem(label='Update Profile', icon='pencil-square'),
                sac.TabsItem(label='Update Webmail Address', icon='envelope'),
            ...
            elif current_tab == 'Update Webmail Address':
