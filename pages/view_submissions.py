...
from helpers import fetch_data, submit_evaluation_accre, submit_evaluation_reval, modify_eval_phase, send_notif_email, get_email, get_abbreviation, authenticate_b2, get_role, update_last_updated
import pandas as pd
    ...
    with st.container(border=True):
        ...
        if not submission_data_df.empty:
            ...
            for idx, row in submission_data_df.iterrows():
                ...
                """
        st.markdown(f"""                <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
                                        ...
                                        """, unsafe_allow_html=True)  # noqa: F541
